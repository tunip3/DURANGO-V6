...
void menurender()
{
    ...
    case Menu::credits:
        ...
        break;
    case Menu::credits1:
        graphics.Print(-1, 50, "Ported to the Xbox One by", tr, tg, tb, true);
        graphics.bigprint(40, 65, "Tunip3", tr, tg, tb, true, 2);
        graphics.Print(-1, 120, "https://github.com/tunip3", tr, tg, tb, true);
        break;
    case Menu::credits2:
...
void gamerender()
{
    ...
    if (map.roomtexton)
    {
     ...
     if(map.custommode && !map.custommodeforreal && !game.advancetext){
        ...
        graphics.bprintalpha(5, 5, "[Press Y to return to editor]", 220 - (help.glow), 220 - (help.glow), 255 - (help.glow / 2), alpha, false);
      }
#endif
    ...
    if (game.readytotele > 100 || game.oldreadytotele > 100)
    {
        ...
        if(graphics.flipmode)
        {
            graphics.bprint(5, 20, "- Press Y to Teleport -", alpha - 20 - (help.glow / 2), alpha - 20 - (help.glow / 2), alpha, true);
        }
        else
        {
            graphics.bprint(5, 210, "- Press Y to Teleport -", alpha - 20 - (help.glow / 2), alpha - 20 - (help.glow / 2), alpha, true);
        }
    }
